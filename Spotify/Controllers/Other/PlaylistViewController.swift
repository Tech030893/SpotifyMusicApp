...
class PlaylistViewController: UIViewController
{
    ...
    @objc func didLongPress(_ gesture: UILongPressGestureRecognizer)
    {
        ...
        let actionSheet = UIAlertController(title: trackToDelete.name, message: "Would you like to remove this song from your current playlist?", preferredStyle: .actionSheet)
...
extension PlaylistViewController: PlaylistHeaderCollectionReusableViewDelegate
{
    ...
    {
        // Start play list play all in queue
